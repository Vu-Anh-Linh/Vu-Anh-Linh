<div align="center">
  <table width="100%" style="border-collapse: collapse; border: 1px solid #30363d; border-radius: 10px; overflow: hidden; background-color: #0d1117;">
    <tr>
      <!-- Column 1: Image -->
      <td width="30%" align="center" valign="middle" style="padding: 15px; border-right: 1px solid #30363d;">
        <img src="https://github.com/Vu-Anh-Linh/Vu-Anh-Linh/blob/main/Vu-Anh-Linh.jpg" width="100%" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.3);" alt="Vũ Ánh Linh" />
      </td>
      <!-- Column 2: Bio Text -->
      <td width="70%" valign="middle" style="padding: 30px; text-align: left;">
        <h1>Vũ Ánh Linh - 靈 | Tech Expat 🇭🇰 🇻🇳</h1>
        <h3>🚀 Digital Marketing & AdTech Specialist</h3>
        <p style="font-size: 1.1em; color: #8b949e;">Building the future of AdTech at the intersection of code and culture.</p>
